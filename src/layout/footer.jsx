...
function Footer() {
  return (
    <footer className="h-full bg-primary/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 mt-20">
        {/* Top area: Blocks */}

        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t-2 border-primary-foreground">
          {/* 1st block */}
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-primary font-bold mb-2">Products</h6>
          ...
          {/* 3rd block */}
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-primary font-bold mb-2">Resources</h6>
            <ul className="text-sm">
              <li className="mb-2">
                <Link
                  to="#"
          ...
          {/* 4th block */}
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-primary font-bold mb-2">Company</h6>
            <ul className="text-sm">
              <li className="mb-2">
                <Link
                  to="#"
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
            <h6 className="text-primary font-bold mb-2">Subscribe</h6>
                ...
                <div className="w-full">
                  ...
                  <div className="relative flex items-center max-w-xs">
                    ...
                    >
                      ...
                      ></span>
                      <svg
                        className="w-3 h-3 fill-current text-primary mx-3 flex-shrink-0"
                        viewBox="0 0 12 12"
        ...
        {/* Bottom area */}
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-primary-foreground">
          {/* Social links */}
          <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
            <li className="ml-4">
              <Link
                ...
                aria-label="github"
              >
                <Github className="w-8 h-8 fill-current p-1" />
              </Link>
            </li>
          </ul>
          ...
          <div className="text-sm text-grayshade-400 dark:text-lightColor-100 mr-4">
            ...
            <a
              ...
              href="https://github.com/LucasBolela"
              target="_blank"
            >
